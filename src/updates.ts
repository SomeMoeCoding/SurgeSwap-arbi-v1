...
export function updateSurgeswapBought(event: boughtEvent): void {
  ...
  .fromString(event.params.beans.toString()).times(bigDecimal.fromString(contract.buyMul().toString())).div(bigDecimal.fromString("1000")).div(bigDecimal.fromString('1000000000000000000'))
